...
import type { ChatMessage, MessageFeedback, ToolOperationStatus } from '@/types/chat'
...
interface ChatState {
  ...
  updateToolStatus: (toolCallId: string, status: ToolOperationStatus, result?: string) => void
  updateFileContent: (content: string[]) => void
  setAgentWorking: (working: boolean) => void
  setAbortController: (controller: AbortController | null) => void
  setMessageFeedback: (messageId: string, feedback: MessageFeedback, feedbackText?: string) => void
