export type ChatMessageType = 'tool_operation' | 'agent_message' | 'user' | 'error'
...
export type ChatMessage = ToolOperationMessage | AgentTextMessage | UserMessage | ErrorMessage
