...
export default function App() {
  ...
  const handleSubmit = useCallback(async (text: string) => {
    ...
    try {
      const generator = sendMessage(responseIndex, fileContent.length, false, controller.signal)
  ...
  }, [addMessage, updateToolStatus, updateFileContent, setAgentWorking, setAbortController, responseIndex, setResponseIndex, fileContent.length])
