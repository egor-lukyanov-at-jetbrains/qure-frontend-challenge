 ...
 */
export function FeedbackForm({ messageId, currentFeedback }: FeedbackFormProps) {
  const [showInput, setShowInput] = useState(false)
  const [feedbackText, setFeedbackText] = useState('')
  const [selectedRating, setSelectedRating] = useState<MessageFeedback>(currentFeedback ?? null)
  const setMessageFeedback = useChatStore((s) => s.setMessageFeedback)

  const handleQuickFeedback = useCallback((rating: MessageFeedback) => {
